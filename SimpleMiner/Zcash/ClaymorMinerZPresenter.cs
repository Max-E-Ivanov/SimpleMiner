...
{
    public class ClaymorZMinerPresenter :IPresenter
    {

        protected readonly string sSettingsFileName = "claymore.xml";
        protected IClaymorZMinerView _view;
        protected ClaymorMinerModel _model;

        public ClaymorZMinerPresenter(IClaymorZMinerView _view, ClaymorMinerModel _model) 
        {           
            this._view = _view;
            this._model = _model;
